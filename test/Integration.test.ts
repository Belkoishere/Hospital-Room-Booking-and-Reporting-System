...
test("Integration test", () => {
    ...
    const room4 = RoomSimpleFactory.AddRoom(
    "IsolationRoom", 
    {RoomID: 4, 
    ...
    const room5 = RoomSimpleFactory.AddRoom(
    "ICUBay", 
    {RoomID: 5, 
    EquipmentList: [Equipment["Bed"], Equipment["InfusionPump"], Equipment["ECG"], Equipment["Defibrilator"], Equipment["PulseOximeter"]], 
    DailyCost: 26, 
    ...
    const params1 = new Map<string, any>([["Type", "All"]]);
    ...
    const params2 = new Map<string, any>([["Type", "All"]]);
    ...
    const params3 = new Map<string, any>([["Type", "All"]]);
    ...
    const params4 = new Map<string, any>([["Type", "All"]]);
